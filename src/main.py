...
Email = re.compile(r"\b[a-zA-Z0-9\-._+%]+@[a-zA-Z0-9\.\-]+\.com\b", re.I)  #Username:letters, digits,dot, hyphen or _ @ domain: letters, -, .
...
Card = re.compile(r"\b(\d{1,6}[-\s]?){4}")  # 4 groups of 4 digits each, or 5 or 6.
